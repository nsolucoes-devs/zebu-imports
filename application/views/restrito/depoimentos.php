            ...
            <div class="c-card-header">
                <div class="row">
                    <div class="col-md-6 text-left">
                        <h2 style="color: #4da751; margin: 4% 5% 2% 1%;"><b>LISTAGEM DE DEPOIMENTOS</b></h2>
                    </div>
                    <div class="col-md-6">
                        <form action="<?php echo base_url('42f4c8bb06112b55d9b0e4c2f81203e5') ?>" method="post">
                        
                            <div class="button-area">
                                <a href="<?php echo base_url('admin/admindepoimentos/caddepoimento') ?>"><button type="button" class="btn btn-primary" style="margin-right: 15px" title="Adicionar Item"><em class="fa fa-plus"></em></button></a>
                ...
                <div class="table-responsive" style="width: 100%">
                    ...
                    <tbody>
                        <?php foreach($depoimentos as $d) { ?>
                            <tr>
                                <td><?php echo mb_strtoupper($d['depoimento_titulo']) ?></td>
                                <td>
                                    <?php if($d['depoimento_onindex'] == 1) { ?>
                                        Ativo
                                    <?php } else { ?>
                                        Desativado
                                    <?php } ?>
                                ...
                                <td style="color: #4da751;" class="text-center">
				                    <a style="color: #4da751;" href="<?php echo base_url('admin/admindepoimentos/depoimento/' . $d['depoimento_id']) ?>"><i style="font-size: 25px" class="fa fa-eye" aria-hidden="true"></i></a>
				                    <a style="color: #4da751;" href="<?php echo base_url('admin/admindepoimentos/editadepoimento/' . $d['depoimento_id']) ?>"><i style="padding-left: 12px; font-size: 25px" class="fa fa-pencil" aria-hidden="true"></i></a>
				                    <i onclick="excluir(<?php echo $d['depoimento_id'] ?>)" data-toggle="modal" data-target="#statusModal" style="padding-left: 12px; font-size: 25px" class="fa fa-trash" aria-hidden="true"></i>
				                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <p style="font-size: 17px;"><b>Deseja excluir o depoimento?</b></p>
      </div>
      <div class="modal-footer">
            <form action="<?php echo base_url('admin/admindepoimentos/delete') ?>" method="post">
    ...
    $(document).ready(function(){
        <?php if(isset($alert)){ ?>
            ...
            <?php } else if($alert == 2) { ?>
                ...
                Toast2.fire({
                    icon: 'success',
                    title: 'Depoimento editado com Sucesso!'
                })
            <?php } else if($alert == 3) { ?>
                const Toast2 = Swal.mixin({
                    toast: true,
