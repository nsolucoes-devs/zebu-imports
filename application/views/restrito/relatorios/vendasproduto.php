        ...
        <section id="container" style="position: relative; margin-right: 1%; margin-left: 1%; width: 98%">
            <div class="row" style="margin-bottom: 10px; display: inline;">
                ...
                <div style="margin-top: -89px;margin-left: 191px;">
                    ...
                    <h3 style="margin-right: 20%; text-align: center; font-weight: bold">RELATÓRIO DE VENDAS POR PRODUTO</h3>
                        ...
                        <tbody>
                            <?php foreach($produtos['itens'] as $p){ ?>
                                <tr style="border-bottom: 1px solid lightgrey; font-size: 12px">
                                    <td style="padding: 7px;"><?php echo $p['nome'] ?></td>
                            ...
                            <tr style="border-top: 2px solid lightgrey; font-size: 13px">
                                <td></td>
                                <td style="padding: 12px;" class="text-center"><b>TOTAL QUANTIDADE</b></td>
                                <td class="text-center"><b>TOTAL APROVADO</b></td>
                                <td class="text-center"><b>TOTAL NEGADO</b></td>
                                <td class="text-center"><b>TOTAL AGUARDANDO</b></td>
