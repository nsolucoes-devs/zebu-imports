                            ...
                            <?php if($carrinho['uploads']){ ?>
                                <?php foreach($carrinho['uploads'] as $u){ ?>
                                    <div class="col-xl-12 form-group">
                                        ...
                                        <button type="button" onclick="$(this).next().click()" class="btn btn-primary">Insira Documento</button>
                                        <input onchange="documentTest(this)" type="file" name="upload" id="upload" class="uploads" style="width: 0%;">
                                    </div><br>
                                <?php } ?>
                            <?php } ?>
                        <?php } else { ?>
    ...
    function finaliza(){
        ...
        if(check.checked){
            ...
            $('.uploads').each(function(){
                ...
                // }else{
                //     if($(this).val() == ""){
                //         uploads = uploads + "¬" + "1-0.jpg";
                //     } else {
                //         uploads = uploads + "¬" + $(this).val();
                //     }
                // }
            });
            if(boolean){
            ...
            $("#encerraCompra").html("Processando, aguarde...");
                ...
                $('.uploads').each(function(){
                    ...
                    dados.append('uploadImagem_'+i, $(this)[0].files[0]);
