            ...
            <div class="c-card-header">
                <div class="row">
                    <div class="col-md-12 text-left">
                        <h2 style="color: #1b9045;"><b>Editar Estoque</b></h2>
                    </div>
                </div>
            </div>
                                ...
                                <div id="parametro">
                                    ...
                                    <div class="row" style="margin-top: 2%">
                                        <div class="col-md-2 form-group">
                                            ...
                                            <input type="date" id="data" name="data" class="form-control" placeholder="XX/XX/XXXX" required>
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label><b>Hora:</b></label>
                                            <input type="time" id="hora" name="hora" class="form-control" placeholder="XX:XX" required>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label><b>Tipo:</b></label>
                                            <select id="tipo" name="tipo" class="js-example-basic-multiple" style="width: 100%!important" required>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <select id="loja" name="loja" class="js-example-basic-multiple" style="width: 100%!important" required>
                                                <option value="m">Metro</option>
                                                <option value="cm">Centímetro</option>
                                                <option value="mm" selected>Milímetro</option>
                                                <option value='"'>Polegadas</option>
                                ...
                                <div id="itens" style="display: none">
                                    ...
                                    <div class="row" style="margin-top: 2%">
                                        <div class="row">
                                            ...
                                            <div class="col-md-1" style="position: relative; left: 4%;">
                                                <a data-toggle="modal" data-target="#add-produto"><button type="button" class="btn btn-primary" style="margin-right: 37%; position: relative;" title="Adicionar Produto"><em class="fa fa-plus"></em></button></a>
                                            </div>
                                            <div class="col-md-3">
                                                <form method="post">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center form-group">
                                    <div class="col-md-12 text-right">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="<?php echo base_url('admin/adminestoque/estoques') ?>" style="margin-right: 15px;" class="btn btn-danger">Cancelar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="add-produto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('restrito/editaestoque');?>" method="post" id="form-cad">
