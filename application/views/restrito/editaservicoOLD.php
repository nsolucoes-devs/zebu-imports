                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="dados" role="tabpanel" aria-labelledby="dados-tab">
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <textarea id="resumo" name="resumo" class="form-control" placeholder="Digite o breve resumo do serviço" <?php if($func == "edita" || $func == "cadastro"){ echo "required";}else{ echo "readonly";}?>><?php echo $servico['servico_resumo'] ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="promocoes" role="tabpanel" aria-labelledby="promocoes-tab">
                                ...
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        <label><b>Data inicial:</b></label>
                                        <input type="date" id="dataInicial" name="dataInicialCupom" class="form-control" placeholder="Data inicial" value="<?php echo $servico['servico_dataInicial_cupom'] ?>">
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label><b>Data final:</b></label>
                                        <input type="date" id="dataFinal" name="dataFinalCupom" class="form-control" placeholder="Data final" value="<?php echo $servico['servico_dataFinal_cupom'] ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 form-group">
