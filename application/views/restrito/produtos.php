            ...
            <div class="c-card-header">
                <div class="row">
                    <div class="col-md-6 text-left">
                        <h2 style="color: #3a0b0c;"><b>LISTAGEM DE PRODUTOS</b></h2>
                    </div>
            ...
            <div class="c-card-body">
                <div class="table-responsive" style="width: 100%">
                    ...
                    <tbody>
			            ...
			            <tr class="tr-check">
			                <td><?php echo mb_strtoupper($prod['produto_nome']) ?></td>
			                <td><?php echo mb_strtoupper($prod['produto_modelo']) ?></td>
			                ...
			                <td style="color: #3a0b0c;" class="text-center">
			                    <a style="color: #3a0b0c;" href="<?php echo base_url('42f4c8bb0611326498144132e81203e5/' . $prod['produto_id']) ?>"><i style="font-size: 25px" class="fa fa-eye" aria-hidden="true"></i></a>
			                    <a style="color: #3a0b0c;" href="<?php echo base_url('ba641dd761d2b77e2dd91ebff5201646/' . $prod['produto_id']) ?>"><i style="padding-left: 12px; font-size: 25px" class="fa fa-pencil" aria-hidden="true"></i></a>
			                    <i onclick="excluirproduto(<?php echo $prod['produto_id'] ?>)" data-toggle="modal" data-target="#statusModal" style="padding-left: 12px; font-size: 25px" class="fa fa-trash" aria-hidden="true"></i>
			                </td>
			            </tr>
			            <?php } ?>
                    </tbody>
